...
struct WaterParameters {
  WaterParameters() {}
  WaterParameters(bool enable_structural_constraints,
...
struct Water {
  Water() {}
  Water(double width, double height, int num_width_points,
        int num_height_points, float thickness);
  ~Water();

  void buildGrid();

  void simulate(double frames_per_sec, double simulation_steps, WaterParameters *cp,
